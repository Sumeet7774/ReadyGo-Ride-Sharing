      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-soft border border-gray-100">
            <div className="rounded-full p-2 bg-primary-50 shadow-inner">
              <img
            ...
            <span className="text-sm font-semibold text-gray-700">ReadyGo Passenger</span>
          </div>
          <h2 className="mt-4 text-3xl font-bold text-gray-900">Welcome back</h2>
          <p className="text-gray-600 text-sm">Sign in to continue your journey</p>
        </div>
        
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-soft p-6 border border-gray-100">
          {error && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 appearance-none block w-full px-3 py-2.5 border border-gray-200 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm bg-white"
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            <Link
              to="/captain-login"
              className="w-full flex items-center justify-center py-2.5 px-4 border border-gray-200 rounded-xl shadow-sm text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition duration-150"
            >
        ...
        <div className="text-center mt-6 text-xs text-gray-500">
          &copy; 2025 ReadyGo. Ride smarter.
        </div>
      </div>
    </div>
  )
