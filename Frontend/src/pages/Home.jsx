...
const Home = () => {
    ...
    return (
            ...
            <div className='fixed top-0 w-screen z-50 bg-white shadow-md px-4 md:px-8 py-3 md:py-5 flex items-center justify-between'>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        ...
                        className='group h-10 w-10 flex items-center justify-center bg-gray-100 rounded-full shadow-sm hover:bg-red-100 transition-all'
                    >
        ...
        <ConfirmDialog
            ...
            title="Log out?"
            message="You will be logged out of your passenger account."
            confirmLabel="Logout"
            cancelLabel="Stay"
